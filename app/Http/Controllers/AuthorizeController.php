...
if ($response != null)
            {
              ...
              {
                error_log("Charge Credit Card AUTH CODE : " . $tresponse->getAuthCode() . "\n");
                error_log("Charge Credit Card TRANS ID  : " . $tresponse->getTransId() . "\n");
              }
              else
              {
                error_log("Charge Credit Card ERROR :  Invalid response\n");
              }
            }
            else
            {
                error_log( "Charge Credit Card Null response returned");
            }
